""" leer los .dat y convertirlos a un unico .npy """
...
files = sorted(glob.glob("./facen/bario/*.dat"))
HAS_HEADER = True
wf = []
segmentos = []
counter = 0
...
# plt.step(range(len(segmentos[0])), segmentos[0])
np.save('bario', np.array(segmentos))
